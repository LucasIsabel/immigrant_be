...
describe('extractResetTokenFromBetterAuthUrl', () => {
  it('returns provided token when valid', () => {
    const url =
      'https://api.aloravia.com/api/v1/auth/reset-password/some-token?callbackURL=%2Freset-password';
  ...
  it('extracts token from query string when present', () => {
    const url =
      'https://api.aloravia.com/api/v1/auth/reset-password?token=query-token';
  ...
  it('extracts token from path when not in query', () => {
    const url =
      'https://api.aloravia.com/api/v1/auth/reset-password/path-token?callbackURL=%2Freset-password';
  ...
  it('returns null when token cannot be determined', () => {
    const url =
      'https://api.aloravia.com/api/v1/auth/reset-password?callbackURL=%2Freset-password';
