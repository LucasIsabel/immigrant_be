...
const categories = [
  ...
  {
    name: 'Trabalho e Mercado Profissional',
    slug: 'trabalho-e-mercado-profissional',
  },
  ...
  {
    name: 'Mudanças na Lei e Atualizações Oficiais',
    slug: 'mudancas-na-lei-e-atualizacoes-oficiais',
  },
  { name: 'Guias Passo a Passo', slug: 'guias-passo-a-passo' },
  { name: 'Erros Comuns no Processo', slug: 'erros-comuns-no-processo' },
  {
    name: 'Validação de Diploma e Profissões Regulamentadas',
    slug: 'validacao-de-diploma-e-profissoes-regulamentadas',
  },
  ...
  {
    name: 'Cidadania e Residência Permanente',
    slug: 'cidadania-e-residencia-permanente',
  },
  {
    name: 'Entrevistas e Histórias Reais',
    slug: 'entrevistas-e-historias-reais',
  },
  {
    name: 'Ferramentas e Recursos Úteis',
    slug: 'ferramentas-e-recursos-uteis',
  },
];
